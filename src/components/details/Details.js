...
const Details = () => {
  ...
  const { id, title, price, description, image, inCart, rating } =
    detailProduct;
  console.log(inCart);
  return (
    <div className="detail-product-container">
      ...
      <div className="detail-product-info">
        ...
        <div className="detail-product-btn-container">
          <Link to="/">
            <button className="detail-product-btn">continue shopping</button>
          </Link>
          <button
            className={
              inCart ? "detail-product-inCart-btn" : "detail-product-btn"
            }
